        ...
        <div className="mx-auto max-w-4xl">
          <div className="mb-8 text-center">
            ...
            <p className="text-lg text-muted-foreground">
              Your personal mental health companion, here to support your well-being
              journey.
            </p>
          </div>
          ...
          <div className="mt-12">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  We&apos;re here to support your mental well-being journey through
              ...
              <CardContent className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Monitor your emotional well-being and track improvements over time.
                  </p>
                </div>
                <div>
                  <h3 className="mb-2 font-semibold">Personalized Experience</h3>
                  <p className="text-sm text-muted-foreground">
                    Get tailored support based on your unique needs and preferences.
                  </p>
                </div>
                <div>
